...
function enqueue_assets() {
	...
	wp_enqueue_script( CHILD_TEXT_DOMAIN . '-notice-update', CHILD_URL . '/assets/js/notice-update.js', array( 'jquery' ), CHILD_THEME_VERSION, true );
	...
	wp_localize_script( CHILD_TEXT_DOMAIN . '-responsive-menu', 'ballastL10n', $localized_script_args );
	wp_localize_script( CHILD_TEXT_DOMAIN . '-notice-update', 'ballastL10n', $localized_script_args );
