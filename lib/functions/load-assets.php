...
function enqueue_assets() {
	...
	wp_enqueue_script( CHILD_TEXT_DOMAIN . '-scripts-min', CHILD_URL . '/assets/js/scripts.min.js', array( 'jquery' ), CHILD_THEME_VERSION, true );
	...
	wp_localize_script( CHILD_TEXT_DOMAIN . '-scripts-min', 'ballastL10n', $localized_script_args );
