...
add_action( 'wp_enqueue_scripts', __NAMESPACE__ . '\build_the_inline_css_from_customizer_settings' );
/**
...
function build_the_inline_css_from_customizer_settings() {
	...
	$color_link = get_theme_mod( $prefix . '_link_color', customizer_get_default_link_color() );
	$color_accent = get_theme_mod( $prefix . '_accent_color', customizer_get_default_accent_color() );
